                            ...
                            <form className="flex flex-column" key={`col-1-${index}-$`}>
                                ...
                                <div className="border w-1/5 h-20 text-center place-content-center">
                                    ...
                                    <input className="text-center w-full h-20" 
                                        ...
                                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleArrowUpdate(event.target.value, index)}
                                    ></input>
                                </div>
                                <div className="border w-1/5 h-20 text-center place-content-center">
                                    <input className="text-center w-full h-20" 
                                        ...
                                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleScoreUpdate(event.target.value, index)}
                                    ></input>
                                </div>
                                <div className="border w-1/5 h-20 text-center place-content-center">
                                    <input type="checkbox" 
                                        ...
                                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => handleSpotUpdate(event.target.checked, index)}
                                    ></input>
                                </div>
                                <div className="border w-1/5 h-20 text-center place-content-center">
